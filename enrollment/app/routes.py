...
@app.route("/user")
def user():
    User(user_id=1, first_name="Arthur", last_name="de Bortoli", email="arthurdb1999@gmail.com", password="123").save()
    User(user_id=2, first_name="Antonio", last_name="Beckhauser", email="antonio@gmail.com", password="123").save()
